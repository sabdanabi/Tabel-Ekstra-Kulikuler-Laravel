    ...
    <div class="w-[50%] bg-white h-[550px] absolute left-96 top-32 rounded-lg">
        ...
        <div class="flex">
            <div class="ml-20 mt-24 mr-20">
                <div class="flex">
                    <p class="mr-36 font-semibold text-slate-500">Login</p>
                    <a href="/login/register" class="text-sky-500 text-xs mt-2">Register</a>
                </div>
                ...
                <div class="flex h-10 mt-4 relative">
                    ...
                    <p class="text-[10px] absolute bottom-8 left-[68px] text-[#b3b3b3]">atau masuk dengan</p>
                    <hr class="w-16 ml-24">
                </div>
                ...
                <div class="block absolute">
                    ...
                    <button
                        ...
                        <p class="ml-6 text-[11px]">Fcebook</p>
                    </button>
                </div>
            </div>
